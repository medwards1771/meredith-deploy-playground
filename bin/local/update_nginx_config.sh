...
scp bin/local/nginx-server-block-flaskr ubuntu@${MEREDITH_DEPLOY_PLAYGROUND_WEB_SERVER_PUBLIC_IP}:/tmp/nginx-server-block-flaskr
...
sudo mv /tmp/nginx-server-block-flaskr /etc/nginx/sites-available/flaskr
